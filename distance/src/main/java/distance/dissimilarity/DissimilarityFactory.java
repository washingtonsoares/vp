...
public class DissimilarityFactory {
    ...
    public static AbstractDissimilarity getInstance(DissimilarityType type) {
        ...
        } else if (type.equals(DissimilarityType.GAUSSIAN_KERNEL)) {
            return new GaussianKernelDistance();
        } else if (type.equals(DissimilarityType.POLYNOMIAL_KERNEL)) {
            return new PolynomialKernelDistance();
        } else if (type.equals(DissimilarityType.SIGMOID_KERNEL)) {
            return new SigmoidKernelDistance();
        } 

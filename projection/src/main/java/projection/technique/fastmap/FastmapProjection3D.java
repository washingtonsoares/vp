 ...
 * @author Fernando
 */
public class FastmapProjection3D implements Projection {
    ...
    public AbstractMatrix project(AbstractMatrix matrix, AbstractDissimilarity diss) {
        ...
        float[][] projection_aux = new float[matrix.getRowCount()][3];
    ...
    private void doTheFastmap(AbstractMatrix matrix, AbstractDissimilarity diss, float[][] projection) {
        ...
        //projecting the third dimension
        project(matrix, diss, projection, 2);
    }

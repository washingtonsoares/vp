 ...
 */
public class Fastmap extends AbstractDimensionalityReduction {
    ...
    private float distance(AbstractVector vectA, AbstractVector vectB, float[] projA,
            float[] projB, int dimension, AbstractDissimilarity diss) {
        //original distance
    ...
    private int[] chooseDistantObjects(AbstractMatrix matrix, float[][] projection,
            int dimension, AbstractDissimilarity diss) {
